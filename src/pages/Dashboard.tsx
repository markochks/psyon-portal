  ...
  return (
    <section className="flex-1 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <MetricCard title="Оплата труда" value="214 800 ₽" delta="+8,2% к маю" />
        <MetricCard title="KPI" value="94%" delta="цель выполнена" />
        <MetricCard title="Консультации" value="118" delta="+12 к маю" />
        <MetricCard title="Выручка врача" value="2 140 000 ₽" delta="+11,4% к маю" />
      </div>
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[1.5fr_1fr]">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="mb-6 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">Последние 6 месяцев</p>
            </div>
            <BriefcaseMedical className="text-emerald-700" size={22} />
          </div>

          <div className="flex h-64 items-end gap-4">
            {[132, 148, 171, 158, 198, 215].map((value, index) => (
        ...
        <div className="grid gap-6">
          ...
          <InsightCard
            title="Зона внимания"
            items={[
              'Заявки с сайта ниже плана',
              'LTV новых клиентов требует анализа',
              'Есть потенциал по онлайн-консультациям',
            ]}
            muted
          />
        </div>
